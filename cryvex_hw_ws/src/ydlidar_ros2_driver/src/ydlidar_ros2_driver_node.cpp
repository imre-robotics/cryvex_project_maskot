...
int main(int argc, char *argv[]) {
  ...
  // RELIABLE (BestEffort degil): slam_toolbox'un varsayilan lazer aboneligi
  // RELIABLE istiyor, BestEffort bir yayinciyla asla eslesmiyor (sessizce
  // sifir mesaj aliniyor) - RELIABLE yayinci hem RELIABLE hem BestEffort
  // isteyen abonelerle uyumlu calisir, bu yuzden guvenli varsayilan bu.
